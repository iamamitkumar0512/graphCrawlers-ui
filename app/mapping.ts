...
/**
 * Hypergraph entity mapping configuration
 *
 * This mapping defines how TypeScript entity classes correspond to Hypergraph types
 * and properties. Each entity maps to:
 * - typeIds: The Hypergraph type identifiers for the entity
 * - properties: String/number fields mapped to their Hypergraph property IDs
 * - relations: Related entities mapped to their Hypergraph relation IDs
 *
 * This mapping is essential for the Hypergraph React hooks to work correctly
 * with the defined schema entities.
 */
export const mapping: Mapping = {
  // Image entity for storing image URLs (e.g., avatars, featured images)
  Image: {
  ...
  // Project entity for managing project information
  Project: {
  ...
  // PostData entity for storing blog post/article content
  PostData: {
  ...
  // Paragraph entity for managing company content paragraphs
  Paragraph: {
